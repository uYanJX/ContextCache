...
__all__ = [
    ...
    "DialogueMatchEvaluation",
    "ContextMatchEvaluation"
...
dialogue_match = LazyImport(
    "dialogue_match", globals(), "gptcache.similarity_evaluation.rerank"
)
context_match = LazyImport(
    "context_match", globals(), "gptcache.similarity_evaluation.context_match"
)
...
def DialogueMatchEvaluation():
    return dialogue_match.DialogueMatchEvaluation()

def ContextMatchEvaluation():
    return context_match.ContextMatchEvaluation()
